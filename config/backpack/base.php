...
return [
    ...
    */
    ...
    'project_logo'   => '<b>Tecno</b>Lavoura',
    ...
    'scripts' => [
        ...
        'packages/jquery-mask/dist/jquery.mask.min.js',
        'js/buscacep.js',
        'js/app.js',
    ...
    */
    ...
    // 'user_model_fqn' => App\Models\Cadastros\User::class, // works on Laravel >= 8
